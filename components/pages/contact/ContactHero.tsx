...
export function ContactHero(props: any) {
  ...
  return (
    <section className="relative -top-[100px] left-0 w-full h-[40vh] min-h-[500px] flex flex-col bg-tertiary-dark">
      <div className="mt-[100px] border-t-[1px] pt-[50px] border-white">
        <div className="w-full max-w-screen-xl flex flex-col items-center justify-start flex-wrap mx-auto px-4 sm:flex-row">
          <div
            className="w-[200px] h-[200px] rounded-full sm:mr-4 md:w-[300px] md:h-[300px]"
            style={{
          ...
          <div className="w-full text-center py-2 sm:flex-1 sm:text-left">
            ...
            <div className="flex flex-row flex-nowrap text-accent-light">
              <a
                ...
                href="mailto:callie@realestatebycallie.com"
              >
                <FaEnvelope className="mr-2" />
                Callie@realestatebycallie.com
              </a>
              <a
                className="flex flex-row flex-nowrap items-center mx-8"
                href=""
              >
